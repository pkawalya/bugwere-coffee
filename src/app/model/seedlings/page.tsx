...
export default function SeedlingsPage() {
  return (
    <>
      <PageHero title="Seedling Production & Distribution" subtitle="Premium seedlings that give every farmer the best possible start." breadcrumb={[{ label: "Model", href: "/model" }, { label: "Seedlings", href: "/model/seedlings" }]} backgroundImage="/images/hero-2.png" />
