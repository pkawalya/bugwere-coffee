...
export default function ExtensionPage() {
  return (
    <>
      <PageHero title="Agronomic Extension System" subtitle="Expert training and field support that transforms knowledge into yields." breadcrumb={[{ label: "Model", href: "/model" }, { label: "Extension", href: "/model/extension" }]} backgroundImage="/images/hero-4.png" />
