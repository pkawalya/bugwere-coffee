...
const BOARD_MEMBERS = [
  {
    ...
    role: "Board Member",
    bio: "Primrose Kobusingye is a seasoned marketing, communications, and growth leader with over 15 years of senior leadership experience across banking, microfinance, advertising/media, and development sectors. She currently serves as Head of Marketing at Exim Bank Uganda, where she provides strategic oversight of brand, digital growth, customer acquisition, and market positioning in a highly regulated financial environment.\n\nPrimrose brings extensive experience from executive roles at FINCA Uganda, Ecobank Uganda, and Orient Bank Uganda, where she led institution-wide marketing transformations, product innovation, and digital adoption initiatives that delivered sustained revenue growth, strengthened brand equity, and expanded customer reach.\n\nShe is an experienced board member and governance contributor, currently serving as a Board Member of ECLOF Microfinance Uganda and Director of Finance at the Uganda Marketers' Society, and previously as Board Chair of Wilmart Development Foundation, where she provided strategic leadership, strengthened governance, and supported successful resource mobilization initiatives.",
    color: PRIMARY,
  ...
  },
  {
    name: "Moses Rudende",
    role: "Board Member",
    bio: "Moses Rudende is a seasoned media and strategic communications professional with over 16 years of leadership experience across Uganda's broadcast and corporate communications landscape. He has held senior editorial and programming roles, including Programmes Controller and Production Manager, with deep expertise in governance-conscious media operations, stakeholder engagement, and reputation management.\n\nMoses has advised major institutions and brands on integrated communication strategy, crisis response, and public affairs, while also shaping audience-driven radio programming that delivers commercial and social impact. He brings a strong blend of board-level perspective, media leadership, and strategic oversight.",
    color: SECONDARY,
  ...
  },
  {
    name: "Abraham Hadoto",
    role: "Board Member",
    bio: "Abraham Hadoto is a senior development professional with decades of experience in humanitarian response, livelihoods recovery, and inclusive agricultural value chain development across Africa and fragile contexts. His expertise spans coffee, cocoa, and food crop systems, with a strong focus on organic agro-input production, climate-smart agriculture, job creation, and household income resilience.\n\nHe brings ethical leadership, systems thinking, and strong institutional partnerships to deliver measurable social, economic, and environmental impact aligned with ESG and sustainable development frameworks.",
    color: SECONDARY,
  ...
  },
  {
    name: "David Tusubira",
    role: "Board Member",
    bio: "David Tusubira is a serial technology entrepreneur with a decade of experience in technology venture bootstrapping. He holds a bachelor's degree in Electrical Engineering from Makerere University with a strong background in electronics and computer programming.\n\nThroughout his career, David has amassed experience in electronics, electronics manufacturing, automation, renewable energy, internet of things, software development, artificial intelligence, STEM education, and entrepreneurship. His innovative mindset and technical expertise bring a forward-looking perspective to BCC's strategic decisions, bridging the gap between traditional agriculture and emerging technology solutions.",
    color: PRIMARY,
