...
const TESTIMONIALS = [
  { quote: "Before BCC brought coffee seedlings to our village, I struggled to feed my family. Now I have a thriving farm and my children are in school.", name: "Mama Grace", role: "Coffee Farmer, Bugwere" },
  { quote: "The training programs changed everything. I learned how to care for my cocoa plants properly, and my yields have doubled since joining.", name: "James Wanyama", role: "Cocoa Farmer, Pallisa" },
  { quote: "The guaranteed market means I never worry about selling my harvest. BCC buys at fair prices, and I can plan for my family's future.", name: "Sarah Namwanje", role: "Coffee & Cocoa Farmer" },
];
...
export default function Home() {
  return (
    <>
      ...
      {/* ═══ MANIFESTO ═══ */}
      <section id="manifesto" className="py-24 sm:py-32 lg:py-40" style={{ backgroundColor: CREAM }}>
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          <ScrollReveal>
            <div className="max-w-4xl">
              <p className="text-sm font-bold uppercase tracking-widest mb-8" style={{ color: PRIMARY, fontFamily: FONT_OPENSANS }}>
                Our Manifesto
              </p>
              <h2
                className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold leading-[1.15] mb-8"
              ...
              <p className="text-gray-600 text-lg sm:text-xl leading-relaxed max-w-2xl mb-10">
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 px-8 py-4 text-white font-semibold text-sm rounded-full transition-all hover:shadow-xl hover:scale-[1.03]"
      ...
      <section className="py-24 sm:py-32 relative overflow-hidden" style={{ backgroundColor: SECONDARY }}>
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
            {[
              { end: 5000, suffix: "+", label: "Homes with Coffee Seedlings", icon: <Coffee className="w-7 h-7" /> },
              { end: 3700, suffix: "+", label: "Homes with Cocoa Seedlings", icon: <Sprout className="w-7 h-7" /> },
              { end: 7000, suffix: "+", label: "Homes with Fertilizers", icon: <Wheat className="w-7 h-7" /> },
              { end: 15000, suffix: "+", label: "Lives Impacted", icon: <Users className="w-7 h-7" /> },
            ].map((stat, i) => (
            ...
            <ScrollReveal>
              <Link href={NEWS[0].href} className="group block relative overflow-hidden rounded-3xl h-[400px] sm:h-[480px]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  ...
                  <h3
                    className="text-xl sm:text-2xl font-bold text-white leading-snug group-hover:text-[#e87074] transition-colors"
                    style={{ fontFamily: FONT_RALEWAY }}
                  >
                    {NEWS[0].title}
                  </h3>
      ...
      <section className="relative py-24 sm:py-32 overflow-hidden" style={{ backgroundColor: SECONDARY }}>
        ...
        <div className="relative max-w-4xl mx-auto px-6 sm:px-10 text-center">
          <ScrollReveal>
            ...
            <h2
              className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-white leading-[1.1] mb-6"
              style={{ fontFamily: FONT_RALEWAY }}
            >
