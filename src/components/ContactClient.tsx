...
const FALLBACK_SETTINGS: SiteSettings = {
  contact_email: "info@bugwerecoffee.com",
  contact_phone: "+256 (0) XXX XXX XXX",
  contact_location: "Bugwere Region, Eastern Uganda",
};
            ...
            <ScrollReveal className="lg:col-span-2">
              <div className="lg:sticky lg:top-32">
                ...
                <div className="space-y-6 mb-12">
                  {[
                    { icon: <MapPin className="w-5 h-5" />, label: "Location", value: merged.contact_location },
                    { icon: <Mail className="w-5 h-5" />, label: "Email", value: merged.contact_email },
                    { icon: <Phone className="w-5 h-5" />, label: "Phone", value: merged.contact_phone },
                  ].map((item) => (
              ...
              <div className="rounded-3xl p-8 sm:p-10 border border-gray-100 shadow-sm" style={{ backgroundColor: CREAM }}>
                ...
                <form className="space-y-6" onSubmit={handleContactSubmit}>
                  ...
                  <div>
                    ...
                    <select name="subject" className="w-full px-5 py-3.5 bg-white border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[--color-brand]/20 focus:border-[--color-brand] transition-all text-gray-600">
