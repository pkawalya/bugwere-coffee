...
function SocialIcon({ icon: Icon, label, href }: { icon: React.ElementType; label: string; href: string }) {
  ...
  return (
    <div className="relative">
      <a
        href={href}
        className="w-10 h-10 rounded-xl bg-gray-800 flex items-center justify-center text-gray-500 hover:text-white hover:bg-[--color-brand] transition-all duration-300"
        aria-label={label}
...
export default function Footer() {
  return (
    <>
      {/* CTA Band with decorative gradient */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-10 lg:px-8 py-16 lg:py-20">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-white/70 text-lg" style={{ fontFamily: FONT_OPENSANS }}>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-10 mb-14">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-xs" style={{ fontFamily: FONT_OPENSANS }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-gray-500 text-sm" style={{ fontFamily: FONT_OPENSANS }}>
              &copy; {new Date().getFullYear()} Bugwere Coffee Company. All rights
              reserved.
            </p>
            <div className="flex gap-6 text-sm text-gray-500" style={{ fontFamily: FONT_OPENSANS }}>
